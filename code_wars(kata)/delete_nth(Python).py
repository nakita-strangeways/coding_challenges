...
#  this sessions, since the motive usually repeats. He isn't fond of seeing the Eiffel tower 40 
#  times. He tells them that he will only sit during the session if they show the same motive at most 
#  N times. Luckily, Alice and Bob are able to encode the motive as a number. Can you help them to 
...
def delete_nth(order, max_e):
    ...
    for item in order:
      count = order_dict.get(item, 0)

      if count < max_e:
        new_list.append(item)
        order_dict[item] = count+1
